...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within PetAgentPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the PetAgent host.
 *
...
export interface PetAgentPluginManifestV1 {
   ...
   */
  minimumPetAgentVersion?: PluginMinimumHostVersion;
