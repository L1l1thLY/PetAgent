import type { PluginLauncherRegistration } from "@petagent/plugin-sdk";

export const PLUGIN_ID = "petagent-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".petagent-kitchen-sink-demo.txt",
} as const;
