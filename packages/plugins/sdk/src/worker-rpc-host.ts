...
import type { PetAgentPluginManifestV1 } from "@petagent/shared";

import type { PetAgentPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@petagent/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: PetAgentPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@petagent/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
