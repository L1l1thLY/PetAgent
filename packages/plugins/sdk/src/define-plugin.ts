/**
 * `definePlugin` — the top-level helper for authoring a PetAgent plugin.
 *
...
// ---------------------------------------------------------------------------
// PetAgentPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface PetAgentPlugin {
 ...
 * @returns A sealed `PetAgentPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@petagent/plugin-sdk";
