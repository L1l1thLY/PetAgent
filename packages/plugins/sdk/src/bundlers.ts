/**
 * Bundling presets for PetAgent plugins.
 *
 ...
 * to match the PetAgent plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@petagent/plugin-sdk/ui",
    "@petagent/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
