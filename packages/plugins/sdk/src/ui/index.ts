/**
 * `@petagent/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@petagent/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@petagent/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@petagent/plugin-sdk/ui";
 *
