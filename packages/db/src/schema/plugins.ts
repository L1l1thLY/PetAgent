...
import type { PluginCategory, PluginStatus, PetAgentPluginManifestV1 } from "@petagent/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<PetAgentPluginManifestV1>().notNull(),
