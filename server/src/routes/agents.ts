...
import { agents as agentsTable, companies, heartbeatRuns, issues as issuesTable } from "@petagent/db";
...
import { runClaudeLogin } from "@petagent/adapter-claude-local/server";
import {
