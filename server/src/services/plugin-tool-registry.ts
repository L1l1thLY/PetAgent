...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@petagent/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: PetAgentPluginManifestV1, pluginDbId?: string): void;
