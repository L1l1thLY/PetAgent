/**
 * PluginEventBus — typed in-process event bus for the PetAgent plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@petagent/shared";
import type { PluginEvent, EventFilter } from "@petagent/plugin-sdk";
