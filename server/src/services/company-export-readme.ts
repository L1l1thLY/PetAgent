 ...
 */
import type { CompanyPortabilityManifest } from "@petagent/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [PetAgent](https://petagent.ing)");
  lines.push("");
