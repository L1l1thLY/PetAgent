...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local PetAgent state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".petagent/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/petagent",
      ),
    ).toBe(false);
