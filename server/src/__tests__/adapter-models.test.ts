...
import { models as codexFallbackModels } from "@petagent/adapter-codex-local";
import { models as cursorFallbackModels } from "@petagent/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@petagent/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@petagent/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.PETAGENT_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.PETAGENT_OPENCODE_COMMAND = "__petagent_missing_opencode_command__";
