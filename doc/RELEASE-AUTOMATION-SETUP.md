...
This document covers the GitHub and npm setup required for the current PetAgent release model:
...
Do this for every public package that PetAgent publishes.
...
3. add a trusted publisher for the GitHub repository `petagentai/petagent`
...
2. revoke any personal automation token that used to publish PetAgent
