...
- installed adapter list for this PetAgent instance
...
## 8. New Skill: `petagent-create-agent`

Create new skill directory:

- `skills/petagent-create-agent/SKILL.md`
...
Also update `skills/petagent/SKILL.md` to reference this skill for hiring workflows.
...
- `petagent-create-agent` skill + docs updates
