...
This is intentionally separate from the normal PetAgent dev image.
...
```sh
review-checkout-pr petagentai/petagent 432
cd /work/checkouts/petagentai-petagent/pr-432
```
...
## Preview the PetAgent app from the PR
...
- PetAgent's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.petagent-review`.
