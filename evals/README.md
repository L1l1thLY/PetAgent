...
Eval framework for testing PetAgent agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the PetAgent heartbeat skill:
