 ...
 *
 * When the PetAgent UI encounters an adapter type that doesn't have a
 ...
 * runtime dependencies, and PetAgent's UI loads it on demand.
 */

import type { TranscriptEntry } from "@petagent/adapter-utils";
