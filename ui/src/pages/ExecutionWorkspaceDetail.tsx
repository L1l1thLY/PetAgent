...
import type { ExecutionWorkspace, Issue, Project, ProjectWorkspace } from "@petagent/shared";
...
function ExecutionWorkspaceIssuesList({
  ...
  return (
    <IssuesList
      ...
      viewStateKey="petagent:execution-workspace-issues-view"
...
export function ExecutionWorkspaceDetail() {
  ...
  if (workspaceId && activeTab === null) {
    ...
    try {
      const storedTab = localStorage.getItem(`petagent:execution-workspace-tab:${workspaceId}`);
  ...
  const handleTabChange = (tab: ExecutionWorkspaceTab) => {
    try {
      localStorage.setItem(`petagent:execution-workspace-tab:${workspace.id}`, tab);
    } catch {}
      ...
      <div className="space-y-4 overflow-hidden sm:space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Configure the concrete runtime workspace that PetAgent reuses for this issue flow.
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="rounded-2xl border border-border bg-card p-4 sm:p-5">
              ...
              <div className="space-y-4">
                ...
                <Field label="Provision command" hint="Runs when PetAgent prepares this execution workspace">
                  <textarea
