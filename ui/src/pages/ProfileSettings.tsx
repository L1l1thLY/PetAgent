...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@petagent/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in PetAgent file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into PetAgent storage.";
