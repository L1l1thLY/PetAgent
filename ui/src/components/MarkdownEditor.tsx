...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@petagent/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative petagent-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("petagent-mdxeditor", !bordered && "petagent-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "petagent-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
