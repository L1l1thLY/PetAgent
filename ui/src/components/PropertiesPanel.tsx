...
export function PropertiesPanel() {
  ...
  return (
    <aside
      className="glass hidden md:flex rounded-none border-y-0 border-r-0 border-l border-l-[var(--glass-border)] shadow-none flex-col shrink-0 overflow-hidden transition-[width,opacity] duration-200 ease-in-out h-full"
