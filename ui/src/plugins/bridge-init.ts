 ...
 *
 * This is placed on `globalThis.__petagentPluginBridge__` and consumed by
...
declare global {
  ...
  var __petagentPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__petagentPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__petagentPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
