...
- `PETAGENT_APPROVAL_ID` — the resolved approval
- `PETAGENT_APPROVAL_STATUS` — `approved` or `rejected`
- `PETAGENT_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
