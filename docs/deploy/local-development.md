...
summary: Set up PetAgent for local development
---

Run PetAgent locally with zero external dependencies.
...
No Docker or external database required. PetAgent uses embedded PostgreSQL automatically.
...
To open PetAgent to a private network with login enabled:
