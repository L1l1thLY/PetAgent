...
PetAgent supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying PetAgent?** Use `local_trusted` (the default)
