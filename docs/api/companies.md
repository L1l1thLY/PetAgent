...
Manage companies within your PetAgent instance.
...
Company logo uploads use the normal PetAgent attachment size limit.
...
| `logoUrl` | string | Optional PetAgent asset content path for the stored logo image |
