...
- Running a Python script that calls the PetAgent API
...
The script can use the injected environment variables to authenticate with the PetAgent API and perform work.
